...
public class CountryFlagEmojiUtil {
    ...
    public CountryFlagEmojiUtil() {
        ...
        emojiRegionMapper.put("Central-African-Republic", "🇨🇫", "CF");
        ...
        emojiRegionMapper.put("Republic-of-the-Congo", "🇨🇬", "CD");
        emojiRegionMapper.put("DR-Congo", "🇨🇩", "CG");
        emojiRegionMapper.put("Cook-Islands", "🇨🇰", "CK");
        emojiRegionMapper.put("Costa-Rica", "🇨🇷", "CR");
        emojiRegionMapper.put("Côte-d'Ivoire-(Ivory-Coast)", "🇨🇮", "CI");
        ...
        emojiRegionMapper.put("Eswatini-(Swaziland)", "🇸🇿", "SZ");
        emojiRegionMapper.put("Ethiopia", "🇪🇹", "ET");
        emojiRegionMapper.put("Falkland-Islands", "🇫🇰", "FK");
        emojiRegionMapper.put("Faroe-Islands", "🇫🇴", "FO");
        ...
        emojiRegionMapper.put("Jersey", "🇯🇪", "JE");
        ...
        emojiRegionMapper.put("Saint-Barthélemy", "🇧🇱", "BL");
        ...
        emojiRegionMapper.put("Saint-Pierre-and-Miquelon", "🇵🇲", "PM");
        emojiRegionMapper.put("Saint-Vincent-and-the-Grenadines", "🇻🇨", "VC");
        emojiRegionMapper.put("Samoa", "🇼🇸", "WS");
        emojiRegionMapper.put("San-Marino", "🇸🇲", "SM");
        emojiRegionMapper.put("São-Tomé-and-Príncipe", "🇸🇹", "ST");
        ...
        emojiRegionMapper.put("Turks-and-Caicos-Islands", "🇹🇨", "TC");
        emojiRegionMapper.put("Tuvalu", "🇹🇻", "TV");
        emojiRegionMapper.put("Uganda", "🇺🇬", "UG");
        emojiRegionMapper.put("Ukraine", "🇺🇦", "UA");
        emojiRegionMapper.put("United-Arab-Emirates", "🇦🇪", "AE");

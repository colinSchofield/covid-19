        ...
        <MDBCard wide cascade>
          <MDBCardBody cascade className='text-center'>
            ...
            <MDBCol md='12'>
              ...
              <Tooltip title="Java: written backend services" arrow>
                <Image src={JavaImg} rounded width='12%' />
              </Tooltip>
              <Tooltip title="Spring / Spring Boot: Java microservices framework" arrow>
                <Image src={SpringImg} rounded width='12%' />
              </Tooltip>
            </MDBCol>
            <MDBCardText>
              <br/>
